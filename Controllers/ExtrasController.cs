...
namespace Nonamii.Controllers
{
    ...
    public class ExtrasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Extra extra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Extra extra)
        {
            if (id != extra.Id)
            {
                return NotFound();
